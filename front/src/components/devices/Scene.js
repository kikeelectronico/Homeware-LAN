  ...
  return (
    <div>
      <div className="device_card">
        <div className="device_card_color_strip" style={{backgroundColor: "lightsalmon", opacity: props.states.enable ? "1" : "0.4"}}></div>
        <h2 className="device_card_title">{ props.device.name.name }</h2>
        <hr className="device_card_divider"/>
        <div style={{paddingLeft: "35px"}}>
          <Enable id={ props.device.id } states={ props.states } reload={ props.reload }/>
