...
class Device extends React.Component {
  ...
  renderTriggerText() {
    ...
    if (device_triggers.includes(type)) {
      return this.props.devices[operation[0]] + ' (' + (deviceReference.paramCoolName[operation[1]] ? deviceReference.paramCoolName[operation[1]] : operation[1]) + ') ' +  operation[2] + ' ' +  operation[3];
    } else if (type == 'd2d') {
      return this.props.devices[operation[0]] + ' (' + (deviceReference.paramCoolName[operation[1]] ? deviceReference.paramCoolName[operation[1]] : operation[1]) + ') ' +  operation[2] + ' ' +  this.props.devices[operation[3]] + ' (' + (deviceReference.paramCoolName[operation[4]] ? deviceReference.paramCoolName[operation[4]] : operation[4]) + ') ';
    } else if (type == 'time') {
      var days = '';
