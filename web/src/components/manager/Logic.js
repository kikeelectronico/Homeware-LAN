...
class Logic extends React.Component {
  ...
  showTriggerAssistant() {
    this.props.showTriggerAssistant(this.props.id)
  }
  ...
  render() {
    ...
    const operations = this.props.triggers[this.props.id].operation.map((op, i) => {
      return (
        <div key={op + i }>
          <Triggers id={op} triggers={this.props.triggers} devices={this.props.devices} delete={this.props.delete} addTriggerLogic={this.props.addTriggerLogic}  showTriggerAssistant={this.props.showTriggerAssistant}/>
